...
CATALOGO = {
    ...
    "aws_s3_bucket_policy": ("Datos", "politica de bucket"),
    "aws_s3_bucket_public_access_block": ("Datos", "bloqueo de acceso publico"),
    "aws_cloudfront_distribution": ("Entrada", "distribucion de CloudFront"),
    "aws_cloudfront_origin_access_control": ("Entrada", "control de acceso al origen"),
...
PLURALES = {
    ...
    "politica de bucket": "politicas de bucket",
    "bloqueo de acceso publico": "bloqueos de acceso publico",
    "distribucion de CloudFront": "distribuciones de CloudFront",
    "control de acceso al origen": "controles de acceso al origen",
