...
public sealed class KafkaConsumerOptions
{
    ...
    public string GroupId { get; set; } = "insurances-service";

    public bool Enabled { get; set; } = true;
}

/// <summary>
/// Tercer consumidor del mismo topico, con su propio grupo. Fleet,
/// Notifications e Insurances reciben cada evento de forma independiente: ese
/// fan-out es lo que verifica la prueba de integracion sobre Kafka.
/// </summary>
public sealed class RentalEventsConsumer(
    IOptions<KafkaConsumerOptions> options,
    IPolicyIssuer issuer,
    ...
    ILogger<RentalEventsConsumer> logger) : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            IsBackground = true,
            Name = "insurances-rental-events-consumer"
        };
    ...
    private void ConsumeLoop(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                issuer.HandleAsync(integrationEvent, stoppingToken).GetAwaiter().GetResult();
            }
